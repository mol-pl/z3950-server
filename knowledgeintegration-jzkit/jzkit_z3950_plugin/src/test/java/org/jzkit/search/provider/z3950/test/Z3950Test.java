...
public class Z3950Test extends TestCase {
  ...
  public void testOVID() throws Exception {
    System.err.println("\n\nTest Client 2");
    ...
    Z3950ServiceFactory factory = new Z3950ServiceFactory("z3950.ovid.com", 210);
    ...
    SimpleZAuthenticationMethod authMethod = new SimpleZAuthenticationMethod(3, "helsuztest", null, "ovidtest");
    factory.setAuthMethod(authMethod);

    System.err.println("Build IR Query");
    IRQuery query = new IRQuery();
    query.collections = new Vector();

    query.collections.add("CABA");
