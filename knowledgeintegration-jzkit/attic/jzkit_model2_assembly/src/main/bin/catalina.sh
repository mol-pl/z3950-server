...
# JAVA_OPTS="-Dsolr.solr.home=$CATALINA_HOME/solr"
JAVA_OPTS="-Dorg.jzkit.home=$CATALINA_HOME/jzkit -Djavax.sql.DataSource.Factory=org.apache.commons.dbcp.BasicDataSourceFactory"
