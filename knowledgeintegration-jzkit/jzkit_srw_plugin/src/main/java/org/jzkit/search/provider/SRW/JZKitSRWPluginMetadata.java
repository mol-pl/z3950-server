...
@Service("JZKitSRWPluginMetadata")
public class JZKitSRWPluginMetadata implements JZKitPluginMetadata, ApplicationContextAware, org.springframework.context.ApplicationListener {
 
  public static final String CODE = "SRW";
  public static final String CLASS_NAME = "org.jzkit.search.provider.SRW.SRWSearchable";
  public static final String NAME = "JZKit Standard SRW Plugin";
